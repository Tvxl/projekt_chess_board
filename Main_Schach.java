	...
	public Main_Schach() {
		//init aller figuren
				...
				for (int i = 0; i < 8; i++) {
					...
					bauer_weis_temp = new Figur("bauer", start_pos, new ImageIcon(getClass().getResource("/images/wp.png")));
				...
				for (int i = 0; i < 8; i++) {
					...
					bauer_schwarz_temp = new Figur("bauer", start_pos, new ImageIcon(getClass().getResource("/images/bp.png")));
				...
				for (int i = 0; i < 2; i++) {
					turm_weis = new Figur("turm", turm_positions[i], new ImageIcon(getClass().getResource("/images/wr.png")));
					turm_weis.setTeam("weis");
					alle_figuren.add(turm_weis);
				}
				for (int i = 2; i < 4; i++) {
					turm_schwarz = new Figur("turm", turm_positions[i], new ImageIcon(getClass().getResource("/images/br.png")));
				...
				for (int i = 0; i < 2; i++) {
					pferd_weis = new Figur("pferd", pferd_positions[i], new ImageIcon(getClass().getResource("/images/wn.png")));
					pferd_weis.setTeam("weis");
					alle_figuren.add(pferd_weis);
				}
				for (int i = 2; i < 4; i++) {
					pferd_schwarz = new Figur("pferd", pferd_positions[i], new ImageIcon(getClass().getResource("/images/bn.png")));
				...
				Position[] laufer_positions = { new Position(2, 7), new Position(5, 7), new Position(2, 0),
						new Position(5, 0) };
				for (int i = 0; i < 2; i++) {
					laufer_weis = new Figur("laufer", laufer_positions[i], new ImageIcon(getClass().getResource("/images/wb.png")));
					laufer_weis.setTeam("weis");
					alle_figuren.add(laufer_weis);
				}
				for (int i = 2; i < 4; i++) {
					laufer_schwarz = new Figur("laufer", laufer_positions[i], new ImageIcon(getClass().getResource("/images/bb.png")));
					laufer_schwarz.setTeam("schwarz");
					alle_figuren.add(laufer_schwarz);
				}

				// Damen
				Figur dame_weis = new Figur("dame", new Position(3, 7), new ImageIcon(getClass().getResource("/images/wq.png")));
				dame_weis.setTeam("weis");
				alle_figuren.add(dame_weis);

				Figur dame_schwarz = new Figur("dame", new Position(3, 0), new ImageIcon(getClass().getResource("/images/bq.png")));
				dame_schwarz.setTeam("schwarz");
				alle_figuren.add(dame_schwarz);

				// Könige
				Figur koenig_weis = new Figur("konig", new Position(4, 7), new ImageIcon(getClass().getResource("/images/wk.png")));
				koenig_weis.setTeam("weis");
				alle_figuren.add(koenig_weis);

				Figur koenig_schwarz = new Figur("konig", new Position(4, 0), new ImageIcon(getClass().getResource("/images/bk.png")));
